...
import { deleteAccount, patchUserAvatar, getSentGreetings, deleteGreeting } from "../utils/dbCalls";
		...
		<div>
			{isLoggedIn === true ? (
				<>
					...
					<br />
					<button onClick={() => navigate(`/celebrant/${user.uid}`)}>My Birthday Page</button>
